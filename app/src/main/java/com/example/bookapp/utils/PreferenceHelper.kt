...
abstract class SharedPreference(context: Context, preference: SharedPreferences? = null) {

    private val pref =
        preference ?: context.getSharedPreferences(javaClass.canonicalName, Context.MODE_PRIVATE)
